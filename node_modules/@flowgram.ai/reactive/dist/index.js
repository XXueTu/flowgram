...
__export(src_exports, {
  ...
  ReactiveBaseState: () => ReactiveBaseState,
  ReactiveState: () => ReactiveState,
  Tracker: () => Tracker,
  observe: () => observe,
  useObserve: () => useObserve,
  useReactiveState: () => useReactiveState,
  useReadonlyReactiveState: () => useReadonlyReactiveState
});
...
function useObserve(value) {
  const refresh = (0, import_utils.useRefresh)();
  const computationMap = (0, import_react.useMemo)(() => /* @__PURE__ */ new Map(), []);
...
function observe(fc) {
  return function ReactiveObserver(props) {
    ...
    const computationRef = (0, import_react3.useRef)();
    const refresh = (0, import_utils2.useRefresh)();
