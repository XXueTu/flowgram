...
__export(src_exports, {
  ...
  CropSchemaDecoration: () => CropSchemaDecoration,
  DEG_TO_RAD: () => DEG_TO_RAD,
  DecorationStyle: () => DecorationStyle,
  Deferred: () => Deferred,
  Disposable: () => Disposable,
  DisposableCollection: () => DisposableCollection,
  DisposableImpl: () => DisposableImpl,
  Emitter: () => Emitter,
  Event: () => Event,
  FlipSchemaDecoration: () => FlipSchemaDecoration,
  Matrix: () => Matrix,
  MutableToken: () => MutableToken,
  NOOP: () => NOOP,
  OBBRect: () => OBBRect,
  OpacitySchemaDecoration: () => OpacitySchemaDecoration,
  OriginSchemaDecoration: () => OriginSchemaDecoration,
  PI: () => PI,
  PI_2: () => PI_2,
  PaddingSchema: () => PaddingSchema,
  PaddingSchemaDecoration: () => PaddingSchemaDecoration,
  Point: () => Point,
  PositionSchemaDecoration: () => PositionSchemaDecoration,
  PromiseDeferred: () => PromiseDeferred,
  PromisePool: () => PromisePool,
  RAD_TO_DEG: () => RAD_TO_DEG,
  Rectangle: () => Rectangle,
  RectangleAlignTitle: () => RectangleAlignTitle,
  RectangleAlignType: () => RectangleAlignType,
  RequestCache: () => RequestCache,
  RotationSchemaDecoration: () => RotationSchemaDecoration,
  SHAPES: () => SHAPES,
  ScaleSchemaDecoration: () => ScaleSchemaDecoration,
  Schema: () => Schema,
  SchemaDecoration: () => SchemaDecoration,
  ShadowSchemaDecoration: () => ShadowSchemaDecoration,
  SizeSchema: () => SizeSchema,
  SizeSchemaDecoration: () => SizeSchemaDecoration,
  SkewSchemaDecoration: () => SkewSchemaDecoration,
  TintSchema: () => TintSchema,
  TintSchemaDecoration: () => TintSchemaDecoration,
  Transform: () => Transform,
  TransformSchema: () => TransformSchema,
  TransformSchemaDecoration: () => TransformSchemaDecoration,
  _setIdx: () => _setIdx,
  addEventListener: () => addEventListener,
  arrayToSet: () => arrayToSet,
  arrayUnion: () => arrayUnion,
  bindContributionProvider: () => bindContributionProvider,
  bindContributions: () => bindContributions,
  cancelled: () => cancelled,
...
((domUtils2) => {
  ...
  function createElement(ele, ...classNames) {
    ...
    if (classNames.length > 0) {
      element.className = (0, import_clsx.default)(classNames);
    }
    return element;
  }
  ...
  function addClass(element, ...classNames) {
    element.className = (0, import_clsx.default)(classNames.concat(element.className.split(" ")));
  }
  ...
  function classNameWithPrefix(prefix) {
    return (key, opts) => (0, import_clsx.default)(
...
function useRefresh(defaultValue) {
  const [, update] = (0, import_react.useState)(defaultValue);
  return (0, import_react.useCallback)((v) => update(v !== void 0 ? v : {}), []);
}
